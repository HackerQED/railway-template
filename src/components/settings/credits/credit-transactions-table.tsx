...
export function CreditTransactionsTable({
  ...
  const typeFilterOptions = useMemo(
    () => [
      ...
      { label: t('types.PENDING'), value: CREDIT_TRANSACTION_TYPE.PENDING },
      {
        label: t('types.PENDING_CANCEL'),
        value: CREDIT_TRANSACTION_TYPE.PENDING_CANCEL,
      },
      {
          ...
          return (
            <div className="flex items-center gap-2">
              ...
              >
                ...
                {getDisplayName(transaction.type)}
              </Badge>
            </div>
          );
        },
