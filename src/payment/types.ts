...
export interface PricePlan {
  ...
  features?: string[];               // List of features included in this plan (yearly or default)
  monthlyFeatures?: string[];        // List of features for monthly billing
  ...
  yearlyDiscount?: number;           // Hardcoded yearly savings percentage (e.g. 15 = "Save 15%")
}
