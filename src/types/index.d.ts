...
export interface AnalyticsConfig {
  ...
  googleAds?: GoogleAdsConfig;        // Google Ads conversion tracking config
}
...
export interface GoogleAdsConfig {
  googleAdsId?: string;                    // Google Ads account ID (AW-xxx)
  signupConversionLabel?: string;          // Conversion label for signup
  beginCheckoutConversionLabel?: string;   // Conversion label for begin_checkout
  purchaseConversionLabel?: string;        // Conversion label for purchase
}
...
export interface PriceConfig {
  showFreePlan?: boolean;           // Whether to show the free plan in the pricing table (default: true)
...
export type MenuItem = {
  type?: 'item' | 'spacer';           // Optional item type for layout control in navigation
