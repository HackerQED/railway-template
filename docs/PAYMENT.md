...
### Pages
- `/app/[locale]/(dashboard)/(protected)/payment/page.tsx` - Payment processing page with status display
- `/app/[locale]/(dashboard)/(protected)/settings/credits/page.tsx` - Credits and billing management page
